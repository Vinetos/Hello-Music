...
${ANDROID_HOME}/build-tools/26.0.1/apksigner sign --ks ../HelloMusic_Keystore.jks --ks-pass "pass:$storepass" --key-pass "pass:$keypass" --out "../release/$NAME-release.apk" "$NAME-aligned.apk"
